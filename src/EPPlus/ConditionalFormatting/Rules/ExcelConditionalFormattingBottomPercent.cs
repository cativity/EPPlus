...
/// </summary>
public class ExcelConditionalFormattingBottomPercent : ExcelConditionalFormattingRule, IExcelConditionalFormattingTopBottomGroup
{
    /****************************************************************************************/
    ...
    internal ExcelConditionalFormattingBottomPercent(ExcelAddress address,
                                                     int priority,
                                                     ExcelWorksheet worksheet,
                                                     XmlNode itemElementNode,
                                                     XmlNamespaceManager namespaceManager)
        : base(eExcelConditionalFormattingRuleType.BottomPercent,
               address,
               priority,
               worksheet,
               itemElementNode,
