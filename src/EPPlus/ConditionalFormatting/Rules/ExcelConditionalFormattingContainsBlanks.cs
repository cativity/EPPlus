...
/// </summary>
public class ExcelConditionalFormattingContainsBlanks : ExcelConditionalFormattingRule, IExcelConditionalFormattingContainsBlanks
{
    /****************************************************************************************/
    ...
    internal ExcelConditionalFormattingContainsBlanks(ExcelAddress address,
                                                      int priority,
                                                      ExcelWorksheet worksheet,
                                                      XmlNode itemElementNode,
                                                      XmlNamespaceManager namespaceManager)
        : base(eExcelConditionalFormattingRuleType.ContainsBlanks,
               address,
               priority,
               worksheet,
               itemElementNode,
               namespaceManager == null ? worksheet.NameSpaceManager : namespaceManager)
    {
        ...
        {
            this.Formula = string.Format("LEN(TRIM({0}))=0", this.Address.Start.Address);
        }
    }
