...
/// </summary>
public class ExcelConditionalFormattingContainsErrors : ExcelConditionalFormattingRule, IExcelConditionalFormattingContainsErrors
{
    /****************************************************************************************/
    ...
    internal ExcelConditionalFormattingContainsErrors(ExcelAddress address,
                                                      int priority,
               ...
               namespaceManager == null ? worksheet.NameSpaceManager : namespaceManager)
    {
        ...
        {
            this.Formula = string.Format("ISERROR({0})", this.Address.Start.Address);
        }
    }
