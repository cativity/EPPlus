...
/// </summary>
public class ExcelConditionalFormattingEndsWith : ExcelConditionalFormattingRule, IExcelConditionalFormattingEndsWith
{
    /****************************************************************************************/
    ...
    internal ExcelConditionalFormattingEndsWith(ExcelAddress address,
                                                int priority,
                                                ExcelWorksheet worksheet,
                                                XmlNode itemElementNode,
                                                XmlNamespaceManager namespaceManager)
        : base(eExcelConditionalFormattingRuleType.EndsWith,
               address,
               priority,
               worksheet,
               itemElementNode,
    ...
    public string Text
    {
        ...
        set
        {
            ...
            this.Formula = string.Format("RIGHT({0},LEN(\"{1}\"))=\"{1}\"", this.Address.Start.Address, value.Replace("\"", "\"\""));
        }
    }
