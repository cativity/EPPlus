...
public sealed class ExcelChartExAxis : ExcelChartAxis
{
    ...
    public override double DisplayUnit
    {
        ...
        set
        {
            ...
            {
                throw new
                    InvalidOperationException("DisplayUnit property for extended charts can only contain Build in Units, matching the eBuildInUnits enum or be 0 for no units");
            }
        }
    }
