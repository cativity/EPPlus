...
public class ExcelChartExSerie : ExcelChartSerie
{
    ...
    private static void SetLayoutProperties(ExcelChartEx chart, XmlElement ser)
    {
        ...
        switch (chart.ChartType)
        {
            case eChartType.BoxWhisker:
                layoutPr.InnerXml =
                    "<cx:parentLabelLayout val=\"banner\"/><cx:visibility outliers=\"1\" nonoutliers=\"0\" meanMarker=\"1\" meanLine=\"0\"/><cx:statistics quartileMethod=\"exclusive\"/>";
            ...
            case eChartType.RegionMap:
                ...
                layoutPr.InnerXml =
                    $"<cx:geography attribution = \"Powered by Bing\" cultureRegion = \"{ci.TwoLetterISOLanguageName}\" cultureLanguage = \"{ci.Name}\" ><cx:geoCache provider=\"{{E9337A44-BEBE-4D9F-B70C-5C5E7DAFC167}}\"><cx:binary/></cx:geoCache></cx:geography>";
