...
public class ExcelChartDataLabelStandard : ExcelChartDataLabel
{
        ...
        : base(chart, ns, node, nodeName, "c")
    {
        this.AddSchemaNodeOrder(schemaNodeOrder,
                                new string[]
                                {
                                    "idx", "spPr", "txPr", "dLbl", "dLblPos", "showLegendKey", "showVal", "showCatName", "showSerName", "showPercent",
                                    "showBubbleSize", "separator", "showLeaderLines"
                                },
                                new int[] { 0, schemaNodeOrder.Length });
        ...
        else
        {
            ...
            if (topNode == null)
            {
                ...
                topNode.InnerXml =
                    "<c:showLegendKey val=\"0\" /><c:showVal val=\"0\" /><c:showCatName val=\"0\" /><c:showSerName val=\"0\" /><c:showPercent val=\"0\" /><c:showBubbleSize val=\"0\" /> <c:separator>\r\n</c:separator><c:showLeaderLines val=\"0\" />";
            }
