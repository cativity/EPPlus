...
public class ExcelChartPlotArea : XmlHelper, IDrawingStyleBase
{
    ...
    /// </summary>
    public ExcelDrawingFill Fill => this._fill ??= new ExcelDrawingFill(this._firstChart, this.NameSpaceManager, this.TopNode, $"{this._nsPrefix}:spPr", this.SchemaNodeOrder);
    ...
    public ExcelDrawingBorder Border =>
        this._border ??= new ExcelDrawingBorder(this._firstChart,
    ...
    public ExcelDrawingEffectStyle Effect =>
        this._effect ??= new ExcelDrawingEffectStyle(this._firstChart,
                                                     this.NameSpaceManager,
                                                     this.TopNode,
