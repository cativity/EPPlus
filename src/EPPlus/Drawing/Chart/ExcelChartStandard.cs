...
public class ExcelChartStandard : ExcelChart
{
    ...
    internal ExcelChartStandard(ExcelDrawings drawings,
                                XmlNode node,
                                eChartType? type,
                                bool isPivot,
    ...
    internal ExcelChartStandard(ExcelDrawings drawings,
                                XmlNode drawingsNode,
                                eChartType? type,
                                ExcelChart topChart,
                                ExcelPivotTable PivotTableSource,
                                XmlDocument chartXml = null,
    ...
    internal ExcelChartStandard(ExcelChart topChart,
                                XmlNode chartNode,
                                ExcelGroupShape parent,
                                string drawingPath = "xdr:graphicFrame",
                                string nvPrPath = "xdr:nvGraphicFramePr/xdr:cNvPr")
    ...
    internal virtual void InitSeries(ExcelChart chart, XmlNamespaceManager ns, XmlNode node, bool isPivot, List<ExcelChartSerie> list = null) => this.Series.Init(chart, ns, node, isPivot, list);
    ...
    private void Init(ExcelDrawings drawings, XmlNode chartNode)
    {
        ...
        this._chartXmlHelper.AddSchemaNodeOrder(new string[]
                                                {
                                                    "date1904", "lang", "roundedCorners", "AlternateContent", "style", "clrMapOvr", "pivotSource",
                                                    "protection", "chart", "ofPieType", "title", "pivotFmt", "autoTitleDeleted", "view3D", "floor",
                                                    "sideWall", "backWall", "plotArea", "wireframe", "barDir", "grouping", "scatterStyle", "radarStyle",
                                                    "varyColors", "ser", "dLbls", "bubbleScale", "showNegBubbles", "firstSliceAng", "holeSize", "dropLines",
                                                    "hiLowLines", "upDownBars", "marker", "smooth", "shape", "legend", "plotVisOnly", "dispBlanksAs",
                                                    "gapWidth", "upBars", "downBars", "showDLblsOverMax", "overlap", "bandFmts", "axId", "spPr", "txPr",
                                                    "printSettings"
                                                },
    ...
    private void Init3DProperties()
    {
        ...
        this.BackWall = new ExcelChartSurface(this,
                                              this.NameSpaceManager,
                                              this.ChartXml.SelectSingleNode("c:chartSpace/c:chart/c:backWall", this.NameSpaceManager));

        this.SideWall = new ExcelChartSurface(this,
                                              this.NameSpaceManager,
                                              this.ChartXml.SelectSingleNode("c:chartSpace/c:chart/c:sideWall", this.NameSpaceManager));
    }
    ...
    private void CreateNewChart(ExcelDrawings drawings, ExcelChart topChart, XmlDocument chartXml = null, eChartType? type = null)
    {
        if (topChart == null)
        {
            ...
            this._chartNode =
                this.ChartXml.SelectSingleNode(string.Format("c:chartSpace/c:chart/c:plotArea/{0}", this.GetChartNodeText()), this.NameSpaceManager);
        }
        else
        {
            this.ChartXml = topChart.ChartXml;
            ...
            string serieXML = this.GetChartSerieStartXml(type.Value,
                                                         int.Parse(topChart.Axis[0].Id),
                                                         int.Parse(topChart.Axis[1].Id),
    ...
    private static string Add3DPart(string name) => string.Format("<c:{0}><c:thickness val=\"0\"/></c:{0}>", name); //<c:spPr><a:noFill/><a:ln><a:noFill/></a:ln><a:effectLst/><a:sp3d/></c:spPr>
    ...
    internal override void AddAxis()
    {
        ...
        {
            catAx.InnerXml =
                string.Format("<c:axId val=\"{0}\"/><c:scaling><c:orientation val=\"minMax\"/></c:scaling><c:delete val=\"0\" /><c:axPos val=\"b\"/><c:tickLblPos val=\"nextTo\"/><c:crossAx val=\"{1}\"/><c:crosses val=\"autoZero\"/><c:auto val=\"1\"/><c:lblAlgn val=\"ctr\"/><c:lblOffset val=\"100\"/>",
                              axID,
                              axID + 1);

            valAx.InnerXml =
                string.Format("<c:axId val=\"{1}\"/><c:scaling><c:orientation val=\"minMax\"/></c:scaling><c:delete val=\"0\" /><c:axPos val=\"l\"/><c:majorGridlines/><c:tickLblPos val=\"nextTo\"/><c:crossAx val=\"{0}\"/><c:crosses val=\"autoZero\"/><c:crossBetween val=\"between\"/>",
                              axID,
                              axID + 1);
        }
        else
        {
            catAx.InnerXml =
                string.Format("<c:axId val=\"{0}\"/><c:scaling><c:orientation val=\"minMax\"/></c:scaling><c:delete val=\"1\" /><c:axPos val=\"b\"/><c:tickLblPos val=\"none\"/><c:crossAx val=\"{1}\"/><c:crosses val=\"autoZero\"/>",
                              axID,
                              axID + 1);

            valAx.InnerXml =
                string.Format("<c:axId val=\"{0}\"/><c:scaling><c:orientation val=\"minMax\"/></c:scaling><c:delete val=\"0\" /><c:axPos val=\"r\"/><c:tickLblPos val=\"nextTo\"/><c:crossAx val=\"{1}\"/><c:crosses val=\"max\"/><c:crossBetween val=\"between\"/>",
                              axID + 1,
                              axID);
        }
    ...
    internal override ExcelChartTitle GetTitle() => new ExcelChartTitleStandard(this, this.NameSpaceManager, this.ChartXml.SelectSingleNode("c:chartSpace/c:chart", this.NameSpaceManager), "c");

    /// <summary>
    /// True if the chart has a title
    /// </summary>
    public override bool HasTitle => this.ChartXml.SelectSingleNode("c:chartSpace/c:chart/c:title", this.NameSpaceManager) != null;

    /// <summary>
    /// If the chart has a legend
    /// </summary>
    public override bool HasLegend => this.ChartXml.SelectSingleNode("c:chartSpace/c:chart/c:legend", this.NameSpaceManager) != null;
    ...
    {
        get => this._chartXmlHelper.GetXmlNodeBool(_roundedCornersPath);
        set => this._chartXmlHelper.SetXmlNodeBool(_roundedCornersPath, value);
    }
    ...
    public override bool ShowHiddenData
    {
        get =>
            ...
            //!!Inverted value!!
            !this._chartXmlHelper.GetXmlNodeBool(_plotVisibleOnlyPath);
        set =>
    ...
    public override eDisplayBlanksAs DisplayBlanksAs
    {
        ...
        set => this._chartXmlHelper.SetXmlNodeString(_displayBlanksAsPath, value.ToString().ToLower(CultureInfo.InvariantCulture));
    }
    ...
    {
        get => this._chartXmlHelper.GetXmlNodeBool(_showDLblsOverMax, true);
        set => this._chartXmlHelper.SetXmlNodeBool(_showDLblsOverMax, value, true);
    }
    ...
    private bool ExistsAxis(ExcelChartAxis excelChartAxis)
    {
        foreach (ExcelChart chartType in this._plotArea.ChartTypes)
        {
            if (chartType != this)
            {
                if (chartType.XAxis.AxisPosition == excelChartAxis.AxisPosition || chartType.YAxis.AxisPosition == excelChartAxis.AxisPosition)
                {
                    //The axis exists
                    return true;
                }
    ...
    public new ExcelChartLegend Legend =>
        this._legend ??= new ExcelChartLegend(this.NameSpaceManager,
    ...
    {
        get => GetGroupingEnum(this._chartXmlHelper.GetXmlNodeString(this._groupingPath));
        internal set => this._chartXmlHelper.SetXmlNodeString(this._groupingPath, GetGroupingText(value));
    }
    ...
    public new ExcelChartAxisStandard[] Axis => this._axisStandard ??= this._axis.Select(x => (ExcelChartAxisStandard)x).ToArray();
    ...
    {
        get => (ExcelChartAxisStandard)base.XAxis;
    ...
    {
        get => (ExcelChartAxisStandard)base.YAxis;
