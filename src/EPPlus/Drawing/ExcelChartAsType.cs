...
public class ExcelChartAsType
{
    ...
    internal ExcelChartAsType(ExcelDrawing drawing) => this._drawing = drawing;
    ...
    public ExcelChart Chart => this._drawing as ExcelChart;
    ...
    public ExcelAreaChart AreaChart => this._drawing as ExcelAreaChart;
    ...
    public ExcelBarChart BarChart => this._drawing as ExcelBarChart;
    ...
    public ExcelBubbleChart BubbleChart => this._drawing as ExcelBubbleChart;
    ...
    public ExcelDoughnutChart DoughnutChart => this._drawing as ExcelDoughnutChart;
    ...
    public ExcelOfPieChart OfPieChart => this._drawing as ExcelOfPieChart;
    ...
    public ExcelPieChart PieChart => this._drawing as ExcelPieChart;
    ...
    public ExcelLineChart LineChart => this._drawing as ExcelLineChart;
    ...
    public ExcelRadarChart RadarChart => this._drawing as ExcelRadarChart;
    ...
    public ExcelScatterChart ScatterChart => this._drawing as ExcelScatterChart;
    ...
    public ExcelStockChart StockChart => this._drawing as ExcelStockChart;
    ...
    public ExcelSurfaceChart SurfaceChart => this._drawing as ExcelSurfaceChart;
    ...
    public ExcelSunburstChart SunburstChart => this._drawing as ExcelSunburstChart;
    ...
    public ExcelTreemapChart TreemapChart => this._drawing as ExcelTreemapChart;
    ...
    public ExcelBoxWhiskerChart BoxWhiskerChart => this._drawing as ExcelBoxWhiskerChart;
    ...
    public ExcelHistogramChart HistogramChart => this._drawing as ExcelHistogramChart;
    ...
    public ExcelFunnelChart FunnelChart => this._drawing as ExcelFunnelChart;
    ...
    public ExcelWaterfallChart WaterfallChart => this._drawing as ExcelWaterfallChart;
    ...
    public ExcelRegionMapChart RegionMapChart => this._drawing as ExcelRegionMapChart;
