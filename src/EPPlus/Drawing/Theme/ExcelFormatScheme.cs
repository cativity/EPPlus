...
public class ExcelFormatScheme : XmlHelper
{
    ...
    public ExcelThemeFillStyles FillStyle =>
        this._fillStyle ??= new ExcelThemeFillStyles(this.NameSpaceManager,
    ...
    /// </summary>
    public ExcelThemeLineStyles BorderStyle => this._lineStyle ??= new ExcelThemeLineStyles(this.NameSpaceManager, this.TopNode.SelectSingleNode(lineStylePath, this.NameSpaceManager));
