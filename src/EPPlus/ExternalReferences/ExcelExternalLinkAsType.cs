...
public class ExcelExternalLinkAsType
{
    ...
    internal ExcelExternalLinkAsType(ExcelExternalLink externalLink) => this._externalLink = externalLink;
    ...
    /// </summary>
    public ExcelExternalWorkbook ExternalWorkbook => this._externalLink as ExcelExternalWorkbook;
    ...
    /// </summary>
    public ExcelExternalDdeLink DdeLink => this._externalLink as ExcelExternalDdeLink;
    ...
    /// </summary>
    public ExcelExternalOleLink OleLink => this._externalLink as ExcelExternalOleLink;
}