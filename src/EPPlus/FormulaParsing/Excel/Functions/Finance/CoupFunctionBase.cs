...
internal abstract class CoupFunctionBase<T> : ExcelFunction
{
    public override CompileResult Execute(IEnumerable<FunctionArgument> arguments, ParsingContext context)
    {
        ...
        FinanceCalcResult<T>? result = this.ExecuteFunction(FinancialDayFactory.Create(settlementDate, (DayCountBasis)basis),
    ...
    protected abstract FinanceCalcResult<T> ExecuteFunction(FinancialDay settlementDate,
