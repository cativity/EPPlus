...
{
    public FinancialDay_Actual_360(System.DateTime date)
        : base(date)
    {
    }
    ...
    protected override FinancialDay Factory(short year, short month, short day) => new FinancialDay_Actual_360(year, month, day);
}