...
internal class CouponProvider : ICouponProvider
{
    ...
    {
        CoupdaybsImpl? func = new CoupdaybsImpl(FinancialDayFactory.Create(settlement, basis), FinancialDayFactory.Create(maturity, basis), frequency, basis);
    ...
    {
        CoupdaysImpl? func = new CoupdaysImpl(FinancialDayFactory.Create(settlement, basis), FinancialDayFactory.Create(maturity, basis), frequency, basis);
    ...
    {
        CoupdaysncImpl? func = new CoupdaysncImpl(FinancialDayFactory.Create(settlement, basis), FinancialDayFactory.Create(maturity, basis), frequency, basis);
    ...
    {
        CoupnumImpl? func = new CoupnumImpl(FinancialDayFactory.Create(settlement, basis), FinancialDayFactory.Create(maturity, basis), frequency, basis);
    ...
    {
        CouppcdImpl? func = new CouppcdImpl(FinancialDayFactory.Create(settlement, basis), FinancialDayFactory.Create(maturity, basis), frequency, basis);
    ...
    {
        CoupncdImpl? func = new CoupncdImpl(FinancialDayFactory.Create(settlement, basis), FinancialDayFactory.Create(maturity, basis), frequency, basis);
