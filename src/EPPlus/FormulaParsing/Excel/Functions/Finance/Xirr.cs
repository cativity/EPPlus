...
internal class Xirr : ExcelFunction
{
    public override CompileResult Execute(IEnumerable<FunctionArgument> arguments, ParsingContext context)
    {
        ...
        IEnumerable<System.DateTime>? dates = this.ArgsToDoubleEnumerable(new List<FunctionArgument> { arguments.ElementAt(1) }, context)
                                                  .Select(x => System.DateTime.FromOADate(x));
