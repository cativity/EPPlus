...
public class ExcelPivotTable : XmlHelper
{
    ...
    private void CreatePivotTable(ExcelWorksheet sheet, ExcelAddressBase address, int fields, string name, int tblId)
    {
        ...
        this.Relationship = sheet.Part.CreateRelationship(UriHelper.ResolvePartUri(sheet.WorksheetUri, this.PivotTableUri),
                                                          TargetMode.Internal,
    ...
    private static string GetStartXml(string name, ExcelAddressBase address, int fields)
    {
        ...
        xml +=
            $"<extLst><ext xmlns:xpdl=\"http://schemas.microsoft.com/office/spreadsheetml/2016/pivotdefaultlayout\" uri=\"{ExtLstUris.PivotTableDefinition16Uri}\"><xpdl:pivotTableDefinition16/></ext></extLst>";
    ...
    /// </summary>
    public int ValuesFieldPosition { get; set; } = -1;
