...
public class ExcelPivotArea : XmlHelper
{
    ...
    public int? FieldIndex
    {
        ...
        set
        {
            ...
            {
                throw new
                    InvalidOperationException("Field index out out of range. Field index must be -2 (values) or within the index of the PivotTable's Fields collection");
            }
    ...
    public bool DataOnly
    {
        ...
        {
            if (value
                && (this.PivotAreaType == ePivotAreaType.Data
                    || this.PivotAreaType == ePivotAreaType.Normal
                    || this.PivotAreaType == ePivotAreaType.Origin
                    || this.PivotAreaType == ePivotAreaType.TopEnd))
            {
