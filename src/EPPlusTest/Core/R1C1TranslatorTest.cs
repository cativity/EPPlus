...
public class R1C1TranslatorTest
{
    ...
    {
        string? r1c1 = "RC[-1]:R[2]C[3]";
        string? expectedAddress = "A3:E5";
        AssertAddresses(r1c1, expectedAddress);
    }
    ...
    public void TranslateC1FullColumnWithSheet()
    {
        ...
        string? formulaR1C1 = ExcelCellBase.TranslateToR1C1(formula, 1, 2);
    ...
    public void TranslateRCFullColumnWithSheet()
    {
        ...
        string? formula = ExcelCellBase.TranslateFromR1C1(formulaR1C1, 1, 2);
    ...
    {
        string? v1 = ExcelCellBase.TranslateFromR1C1("\" \"\" \"", 1, 2);
        Assert.AreEqual("\" \"\" \"", v1);
    }
    ...
    {
        string? v1 = ExcelCellBase.TranslateToR1C1("\" \"\" \"", 1, 2);
        Assert.AreEqual("\" \"\" \"", v1);
    }

    private static void AssertAddresses(string r1c1, string expectedAddress)
    {
        string? address = R1C1Translator.FromR1C1(r1c1, 3, 2); //From Cell B2
