...
public class RangeFillTests : TestBase
{
    ...
    public void FillDate_Month_LastDayInMonth_NoWeekdays_WithCalender()
    {
        ...
        _wsDate.Cells["M1:N5"]
               .FillDateTime(x =>
               {
                   ...
                   x.SetExcludedDates(new DateTime(2021, 12, 24),
    ...
    public void FillTime_Hours()
    {
        ...
        _wsDate.Cells["A20:B24"]
               .FillDateTime(x =>
               {
                   x.DateTimeUnit = eDateTimeUnit.Hour;
                   x.StartValue = startTime;
                   x.NumberFormat = "hh:mm:ss";
               });
    ...
    public void FillTime_Minutes()
    {
        ...
        _wsDate.Cells["C20:D24"]
               .FillDateTime(x =>
               {
                   x.DateTimeUnit = eDateTimeUnit.Minute;
                   x.StartValue = startTime;
                   x.NumberFormat = "hh:mm:ss";
               });
    ...
    public void FillTime_Seconds()
    {
        ...
        _wsDate.Cells["E20:F24"]
               .FillDateTime(x =>
               {
                   x.DateTimeUnit = eDateTimeUnit.Second;
                   x.StartValue = startTime;
                   x.NumberFormat = "hh:mm:ss";
               });
