...
public class SharedFormulasTest
{
    ...
    {
        ExcelWorksheet.Formulas? f =
            new ExcelWorksheet.Formulas(SourceCodeTokenizer.Default) { Index = 0, Formula = "SUM(C:D)", Address = "A1:B2", StartRow = 1, StartCol = 1 };
    ...
    {
        ExcelWorksheet.Formulas? f =
            new ExcelWorksheet.Formulas(SourceCodeTokenizer.Default) { Index = 0, Formula = "SUM(3:4)", Address = "A1:B2", StartRow = 1, StartCol = 1 };
    ...
    {
        ExcelWorksheet.Formulas? f =
            new ExcelWorksheet.Formulas(SourceCodeTokenizer.Default) { Index = 0, Formula = "SUM(A:XFD)", Address = "A1:B2", StartRow = 1, StartCol = 1 };
