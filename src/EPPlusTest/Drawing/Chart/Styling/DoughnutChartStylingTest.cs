...
public class DoughnutChartStylingTest : TestBase
{
    ...
    private static void DoughnutStyles(ExcelWorksheet ws, eDoughnutChartType chartType)
    {
        ...
        _ = AddDoughnut(ws,
                    ...
                    44,
                    18,
                    ePresetChartStyle.DoughnutChartStyle8,
                    c =>
                    {
        ...
        _ = AddDoughnut(ws,
                    ...
                    44,
                    31,
                    ePresetChartStyle.DoughnutChartStyle9,
                    c =>
                    {
                        c.Legend.Remove();
        ...
        _ = AddDoughnut(ws,
                    ...
                    66,
                    5,
                    ePresetChartStyle.DoughnutChartStyle10,
                    c =>
                    {
    ...
    private static ExcelDoughnutChart AddDoughnut(ExcelWorksheet ws,
                                                  eDoughnutChartType type,
                                                  string name,
                                                  int row,
                                                  int col,
                                                  ePresetChartStyle style,
                                                  Action<ExcelDoughnutChart> SetProperties)
    {
