...
public class OfPieChartStylingTest : TestBase
{
    ...
    private static void OfPieStyles(ExcelWorksheet ws, eOfPieChartType chartType)
    {
        ...
        AddOfPie(ws,
                 ...
                 44,
                 18,
                 ePresetChartStyle.OfPieChartStyle8,
                 c =>
                 {
        ...
        AddOfPie(ws,
                 ...
                 44,
                 31,
                 ePresetChartStyle.OfPieChartStyle9,
                 c =>
                 {
                     c.Legend.Remove();
        ...
        AddOfPie(ws,
                 ...
                 66,
                 5,
                 ePresetChartStyle.OfPieChartStyle10,
                 c =>
                 {
    ...
    private static ExcelOfPieChart AddOfPie(ExcelWorksheet ws,
                                            eOfPieChartType type,
                                            string name,
                                            int row,
                                            int col,
                                            ePresetChartStyle style,
                                            Action<ExcelOfPieChart> SetProperties)
    {
