...
public class SurfaceChartStylingTest : TestBase
{
    ...
    [ClassInitialize]
    public static void Init(TestContext context) => _pck = OpenPackage("SurfaceChartStyling.xlsx", true);
    ...
    private static ExcelSurfaceChart AddSurface(ExcelWorksheet ws,
                                                eSurfaceChartType type,
                                                string name,
                                                int row,
                                                int col,
                                                string xml,
                                                Action<ExcelSurfaceChart> SetProperties)
    {
