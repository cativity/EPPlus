...
public class SparkLineTests : TestBase
{
    ...
    public void ReadSparklines()
    {
        ...
        ExcelSparklineColor? c1 = sg1.ColorMarkers;
    ...
    public void WriteSparklines()
    {
        ...
        //Column<->Row
        ExcelSparklineGroup? sg1 = ws.SparklineGroups.Add(eSparklineType.Line, ws.Cells["A1:A4"], ws.Cells["B1:C4"]);
