...
public class TableTests : TestBase
{
    ...
    public void TableDeleteTest()
    {
        ...
        ExcelWorksheet[]? sheets = new[] { wb.Worksheets.Add("WorkSheet A"), wb.Worksheets.Add("WorkSheet B") };
        ...
        {
            sheets[1].Tables.Add(sheets[1].Cells["A1:D73"], "TableDeletea"), sheets[0].Tables.Add(sheets[0].Cells["A1:D73"], "TableDelete2"),
            sheets[1].Tables.Add(sheets[1].Cells["F3:K10"], "TableDeleteb"), sheets[0].Tables.Add(sheets[0].Cells["F3:K10"], "TableDelete3"),
        };
